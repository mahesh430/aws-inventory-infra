        ...
        if instance.tags:
            ...
            for tag in instance.tags:
                ...
                if key == 'Name':
                    ...
                    instance_info['Stage'] = value
                elif key == 'Terraform':
                    instance_info['Terraform'] = value
            if "-app" in instance_info['InstanceName'] or "-rin" in instance_info['InstanceName']:
                split_value = instance_info['InstanceName'].split('-')
                split_value.reverse()
                if "ha" in instance_info['InstanceName']:
                    instance_info['TenantId'] = split_value[1]
                else:
                    instance_info['TenantId'] = split_value[0]
            ...
            item = {
                ...
                'TenantId': instance_info['TenantId'],
